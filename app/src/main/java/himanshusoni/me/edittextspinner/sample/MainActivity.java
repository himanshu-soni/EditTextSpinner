...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<ListableObject> listableObjects = Arrays.asList(
                new ListableObject("Himanshu Soni", "himanshusoni.me@gmail.com"),
                new ListableObject("Ethan Hunt", "ethanhunt@mi.com"),
                new ListableObject("John C", "john.c@skynet.com")
        );
        ...
        spinner.setOnItemSelectedListener(new EditTextSpinner.OnItemSelectedListener<ListableObject>() {
            ...
            public void onItemSelectedListener(ListableObject item, int selectedIndex) {
                Toast.makeText(MainActivity.this, "Position: " + selectedIndex, Toast.LENGTH_LONG).show();
                if (selectedIndex == 2) {
                    textInputLayout.setError("Please don't select John!!!");
                } else {
